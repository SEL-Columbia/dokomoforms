...
VALUES (the_survey_id, 1, 'integer question', 'integer', '', False),
       ...
       (the_survey_id, 6, 'text question', 'text', '', True),
       (the_survey_id, 8, 'note', 'note', '', False);
...
INSERT INTO question (survey_id, sequence_number, title,
    type_constraint_name, logical_constraint_name, allow_multiple)
VALUES (the_survey_id, 7, 'multiple choice with other question',
           'multiple_choice_with_other', '', False)
RETURNING question_id into the_from_question_id;

INSERT INTO question_choice (choice, choice_number, question_id,
    type_constraint_name, question_sequence_number, allow_multiple, survey_id)
VALUES ('choice a', 1, the_from_question_id, 'multiple_choice_with_other', 7,
    False, the_survey_id);

INSERT INTO question_choice (choice, choice_number, question_id,
    type_constraint_name, question_sequence_number, allow_multiple, survey_id)
VALUES ('choice b', 2, the_from_question_id, 'multiple_choice_with_other', 7,
    False, the_survey_id);
