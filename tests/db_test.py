...
class TestQuestion(unittest.TestCase):
    ...
    def testGetRequired(self):
        survey_id = survey_table.select().where(
            survey_table.c.survey_title == 'what is life').execute(
...
class TestQuestionBranch(unittest.TestCase):
    def tearDown(self):
        ...
        to_question = \
            get_questions_no_credentials(connection,
                                         survey_id).fetchall()[
                -1]
    ...
    def testQuestionBranchInsert(self):
        ...
        choice = \
            get_choices(connection,
                        from_question.question_id).fetchall()[
                0]
...
class TestSubmission(unittest.TestCase):
    ...
    def testGetSubmissionsWithFilter(self):
        ...
        mul = question.allow_multiple
        for i in range(2):
            submission_exec = submission_insert(
